...
target "test-image-1" {
  ...
  # Image name/tag
  tags = [
    "docker.io/kcandidate/gha-test:subdir-v3",
    "docker.io/kcandidate/gha-test:latest-subdir-v3"
  ]
...
target "test-image-2" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-2:v3"
  ]
  platforms = [
    "linux/amd64"
  ]
...
target "test-image-3" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-3:v3"
  ]
  platforms = [
    "linux/arm64"
  ]
