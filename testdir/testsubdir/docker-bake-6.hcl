...
target "test-image-1" {
  ...
  # Image name/tag
  tags = [
    "docker.io/kcandidate/gha-test:subdir-v4",
    "docker.io/kcandidate/gha-test:latest-subdir-v4"
  ]
...
target "test-image-2" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-2:v4"
  ]
  platforms = [
    "linux/amd64"
  ]
...
target "test-image-3" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-3:v4"
  ]
  platforms = [
    "linux/arm64"
  ]
