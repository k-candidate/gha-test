...
target "test-image-1" {
  ...
  # Image name/tag
  tags = [
    "docker.io/kcandidate/gha-test:subdir-v5",
    "docker.io/kcandidate/gha-test:latest-subdir-v5"
  ]
...
target "test-image-2" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-2:v5"
  ]
  platforms = [
    "linux/amd64"
  ]
...
target "test-image-3" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-3:v5"
  ]
  platforms = [
    "linux/arm64"
  ]
