...
target "test-image-1" {
  ...
  # Image name/tag
  tags = [
    "docker.io/kcandidate/gha-test:subdir-v8",
    "docker.io/kcandidate/gha-test:latest-subdir-v8"
  ]
...
target "test-image-2" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-2:v8"
  ]
  platforms = [
    "linux/amd64"
  ]
...
target "test-image-3" {
  ...
  tags = [
    "docker.io/kcandidate/test-image-3:v8"
  ]
  platforms = [
    "linux/arm64"
  ]
